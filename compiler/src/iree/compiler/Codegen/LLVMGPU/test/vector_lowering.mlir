...
// func.func @multi_reduction_no_uplift(%a: vector<4xf32>, %b: vector<4xf32>) -> f32 {
//   %c0 = arith.constant 0.0 : f32
//   %1 = iree_vector_ext.dot %a, %b, %c0 : vector<4xf32>, f32
//   return %1 : f32
// }
...
//     %1 = math.fma %arg0, %arg1, %cst_0 fastmath<contract> : vector<2x1x8xf32>
//     %2 = vector.extract %1[0, 0] : vector<8xf32> from vector<2x1x8xf32>
//     %3 = vector.reduction <add>, %2, %cst : vector<8xf32> into f32
//     %4 = vector.extract %1[1, 0] : vector<8xf32> from vector<2x1x8xf32>
//     %5 = vector.reduction <add>, %4, %cst : vector<8xf32> into f32
//     %6 = vector.insert %3, %0 [0, 0] : f32 into vector<2x1xf32>
//     %7 = vector.insert %5, %6 [1, 0] : f32 into vector<2x1xf32>
//     return %7 : vector<2x1xf32>
//   }
// }